...
class FlightPhase(object):
    ...
    def plot_logics(self):
        ...
        plt.subplot(411)
        plt.plotFlightFeatureVersusTime(self.alt_range, self.alt_gnd, lw=2, label="Ground")
        plt.plotFlightFeatureVersusTime(self.alt_range, self.alt_lo, lw=2, label="Low")
        plt.plotFlightFeatureVersusTime(self.alt_range, self.alt_hi, lw=2, label="High")
        plt.ylim([-0.05, 1.05])
        ...
        plt.subplot(412)
        plt.plotFlightFeatureVersusTime(self.roc_range, self.roc_zero, lw=2, label="Zero")
        plt.plotFlightFeatureVersusTime(self.roc_range, self.roc_plus, lw=2, label="Positive")
        plt.plotFlightFeatureVersusTime(self.roc_range, self.roc_minus, lw=2, label="Negative")
        plt.ylim([-0.05, 1.05])
        plt.ylabel("RoC (ft/m)")
        plt.yticks([0, 1])
        plt.legend()
        ...
        plt.subplot(413)
        plt.plotFlightFeatureVersusTime(self.spd_range, self.spd_hi, lw=2, label="High")
        plt.plotFlightFeatureVersusTime(self.spd_range, self.spd_md, lw=2, label="Midium")
        plt.plotFlightFeatureVersusTime(self.spd_range, self.spd_lo, lw=2, label="Low")
        plt.ylim([-0.05, 1.05])
        plt.ylabel("Speed (kt)")
        plt.yticks([0, 1])
        plt.legend()
        ...
        plt.subplot(414)
        plt.plotFlightFeatureVersusTime(self.states, self.state_ground, lw=2, label="ground")
        plt.plotFlightFeatureVersusTime(self.states, self.state_climb, lw=2, label="climb")
        plt.plotFlightFeatureVersusTime(self.states, self.state_descent, lw=2, label="descent")
        plt.plotFlightFeatureVersusTime(self.states, self.state_cruise, lw=2, label="cruise")
        plt.plotFlightFeatureVersusTime(self.states, self.state_level, lw=2, label="level flight")
        plt.ylim([-0.05, 1.05])
